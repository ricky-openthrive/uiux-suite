...
export function Table(props: TableProps) {
  return (
    <ResizableTableContainer
      ...
      className={twMerge(
        "w-full max-h-80 overflow-auto scroll-pt-[2.281rem] relative bg-white dark:bg-neutral-900 box-border border border-neutral-300 dark:border-neutral-700 rounded-lg font-sans",
        props.className,
      )}
    >
      <AriaTable
